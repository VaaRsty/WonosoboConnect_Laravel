...
return [
    ...
    | framework needs to place the application's name in a notification or other |
    | UI elements where an application name needs to be displayed.                |
    |---------------------------------------------------------------------------|
    */
    ...
    | running in. This may determine how you prefer to configure various services|
    | the application utilizes. Set this in your ".env" file.                    |
    |---------------------------------------------------------------------------|
    */
    ...
    */
    ...
    | manage Laravel's "maintenance mode" status. The "cache" driver will allow |
